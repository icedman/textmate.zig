...
const theme_61 = @embedFile("themes/ayu-light.json");
const theme_62 = @embedFile("themes/ayu-mirage.json");
const theme_63 = @embedFile("themes/horizon-bright.json");
const theme_64 = @embedFile("themes/horizon.json");
const theme_65 = @embedFile("themes/night-owl-light.json");
...
const grammar_168 = @embedFile("grammars/raku.json");
const grammar_169 = @embedFile("grammars/razor.json");
const grammar_170 = @embedFile("grammars/reg.json");
const grammar_171 = @embedFile("grammars/regexp.json");
const grammar_172 = @embedFile("grammars/rel.json");
const grammar_173 = @embedFile("grammars/riscv.json");
const grammar_174 = @embedFile("grammars/rst.json");
const grammar_175 = @embedFile("grammars/ruby.json");
const grammar_176 = @embedFile("grammars/rust.json");
const grammar_177 = @embedFile("grammars/sas.json");
const grammar_178 = @embedFile("grammars/sass.json");
const grammar_179 = @embedFile("grammars/scala.json");
const grammar_180 = @embedFile("grammars/scheme.json");
const grammar_181 = @embedFile("grammars/scss.json");
const grammar_182 = @embedFile("grammars/sdbl.json");
const grammar_183 = @embedFile("grammars/shaderlab.json");
const grammar_184 = @embedFile("grammars/shellscript.json");
const grammar_185 = @embedFile("grammars/shellsession.json");
const grammar_186 = @embedFile("grammars/smalltalk.json");
const grammar_187 = @embedFile("grammars/solidity.json");
const grammar_188 = @embedFile("grammars/soy.json");
const grammar_189 = @embedFile("grammars/sparql.json");
const grammar_190 = @embedFile("grammars/splunk.json");
const grammar_191 = @embedFile("grammars/sql.json");
const grammar_192 = @embedFile("grammars/ssh-config.json");
const grammar_193 = @embedFile("grammars/stata.json");
const grammar_194 = @embedFile("grammars/stylus.json");
const grammar_195 = @embedFile("grammars/svelte.json");
const grammar_196 = @embedFile("grammars/swift.json");
const grammar_197 = @embedFile("grammars/system-verilog.json");
const grammar_198 = @embedFile("grammars/systemd.json");
const grammar_199 = @embedFile("grammars/talonscript.json");
const grammar_200 = @embedFile("grammars/tasl.json");
const grammar_201 = @embedFile("grammars/tcl.json");
const grammar_202 = @embedFile("grammars/templ.json");
const grammar_203 = @embedFile("grammars/terraform.json");
const grammar_204 = @embedFile("grammars/tex.json");
const grammar_205 = @embedFile("grammars/toml.json");
const grammar_206 = @embedFile("grammars/ts-tags.json");
const grammar_207 = @embedFile("grammars/tsv.json");
const grammar_208 = @embedFile("grammars/tsx.json");
const grammar_209 = @embedFile("grammars/turtle.json");
const grammar_210 = @embedFile("grammars/twig.json");
const grammar_211 = @embedFile("grammars/typescript.json");
const grammar_212 = @embedFile("grammars/typespec.json");
const grammar_213 = @embedFile("grammars/typst.json");
const grammar_214 = @embedFile("grammars/v.json");
const grammar_215 = @embedFile("grammars/vala.json");
const grammar_216 = @embedFile("grammars/vb.json");
const grammar_217 = @embedFile("grammars/verilog.json");
const grammar_218 = @embedFile("grammars/vhdl.json");
const grammar_219 = @embedFile("grammars/viml.json");
const grammar_220 = @embedFile("grammars/vue-directives.json");
const grammar_221 = @embedFile("grammars/vue-html.json");
const grammar_222 = @embedFile("grammars/vue-interpolations.json");
const grammar_223 = @embedFile("grammars/vue-sfc-style-variable-injection.json");
const grammar_224 = @embedFile("grammars/vue-vine.json");
const grammar_225 = @embedFile("grammars/vue.json");
const grammar_226 = @embedFile("grammars/vyper.json");
const grammar_227 = @embedFile("grammars/wasm.json");
const grammar_228 = @embedFile("grammars/wenyan.json");
const grammar_229 = @embedFile("grammars/wgsl.json");
const grammar_230 = @embedFile("grammars/wikitext.json");
const grammar_231 = @embedFile("grammars/wit.json");
const grammar_232 = @embedFile("grammars/wolfram.json");
const grammar_233 = @embedFile("grammars/xml.json");
const grammar_234 = @embedFile("grammars/xsl.json");
const grammar_235 = @embedFile("grammars/yaml.json");
const grammar_236 = @embedFile("grammars/zenscript.json");
const grammar_237 = @embedFile("grammars/zig.json");
const grammar_238 = @embedFile("grammars/racket.json");
const grammar_239 = @embedFile("grammars/ahk2.json");
const grammar_240 = @embedFile("grammars/ahk.json");
const grammar_241 = @embedFile("grammars/bird2.json");
const grammar_242 = @embedFile("grammars/c3.json");
const grammar_243 = @embedFile("grammars/chapel.json");
const grammar_244 = @embedFile("grammars/gn.json");
const grammar_245 = @embedFile("grammars/hurl.json");
const grammar_246 = @embedFile("grammars/just.json");
const grammar_247 = @embedFile("grammars/kdl.json");
const grammar_248 = @embedFile("grammars/markdown-nix.json");
const grammar_249 = @embedFile("grammars/moonbit.json");
const grammar_250 = @embedFile("grammars/nextflow-groovy.json");
const grammar_251 = @embedFile("grammars/odin.json");
const grammar_252 = @embedFile("grammars/openscad.json");
const grammar_253 = @embedFile("grammars/org.json");
const grammar_254 = @embedFile("grammars/pkl.json");
const grammar_255 = @embedFile("grammars/ron.json");
const grammar_256 = @embedFile("grammars/rosmsg.json");
const grammar_257 = @embedFile("grammars/surrealql.json");
