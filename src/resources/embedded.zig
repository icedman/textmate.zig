...
const theme_1 = @embedFile("themes/aurora-x.json");
const theme_2 = @embedFile("themes/dark-plus.json");
const theme_3 = @embedFile("themes/dracula-soft.json");
const theme_4 = @embedFile("themes/dracula.json");
const theme_5 = @embedFile("themes/everforest-dark.json");
const theme_6 = @embedFile("themes/everforest-light.json");
const theme_7 = @embedFile("themes/github-dark-default.json");
const theme_8 = @embedFile("themes/github-dark-dimmed.json");
const theme_9 = @embedFile("themes/github-dark-high-contrast.json");
const theme_10 = @embedFile("themes/github-dark.json");
const theme_11 = @embedFile("themes/github-light-default.json");
const theme_12 = @embedFile("themes/github-light-high-contrast.json");
const theme_13 = @embedFile("themes/github-light.json");
const theme_14 = @embedFile("themes/houston.json");
const theme_15 = @embedFile("themes/kanagawa-dragon.json");
const theme_16 = @embedFile("themes/kanagawa-lotus.json");
const theme_17 = @embedFile("themes/kanagawa-wave.json");
const theme_18 = @embedFile("themes/laserwave.json");
const theme_19 = @embedFile("themes/light-plus.json");
const theme_20 = @embedFile("themes/material-theme-darker.json");
const theme_21 = @embedFile("themes/material-theme-lighter.json");
const theme_22 = @embedFile("themes/material-theme-ocean.json");
const theme_23 = @embedFile("themes/material-theme-palenight.json");
const theme_24 = @embedFile("themes/material-theme.json");
const theme_25 = @embedFile("themes/min-dark.json");
const theme_26 = @embedFile("themes/min-light.json");
const theme_27 = @embedFile("themes/monokai.json");
const theme_28 = @embedFile("themes/night-owl.json");
const theme_29 = @embedFile("themes/nord.json");
const theme_30 = @embedFile("themes/one-dark-pro.json");
const theme_31 = @embedFile("themes/plastic.json");
const theme_32 = @embedFile("themes/poimandres.json");
const theme_33 = @embedFile("themes/red.json");
const theme_34 = @embedFile("themes/slack-dark.json");
const theme_35 = @embedFile("themes/slack-ochin.json");
const theme_36 = @embedFile("themes/snazzy-light.json");
const theme_37 = @embedFile("themes/solarized-dark.json");
const theme_38 = @embedFile("themes/solarized-light.json");
const theme_39 = @embedFile("themes/synthwave-84.json");
const theme_40 = @embedFile("themes/tokyo-night.json");
const theme_41 = @embedFile("themes/vitesse-black.json");
const theme_42 = @embedFile("themes/vitesse-dark.json");
const theme_43 = @embedFile("themes/vitesse-light.json");
const theme_44 = @embedFile("themes/andromeeda.json");
const theme_45 = @embedFile("themes/ayu-dark.json");
const theme_46 = @embedFile("themes/ayu-light.json");
const theme_47 = @embedFile("themes/ayu-mirage.json");
const theme_48 = @embedFile("themes/catppuccin-frappe.json");
const theme_49 = @embedFile("themes/catppuccin-latte.json");
const theme_50 = @embedFile("themes/catppuccin-macchiato.json");
const theme_51 = @embedFile("themes/catppuccin-mocha.json");
const theme_52 = @embedFile("themes/gruvbox-dark-hard.json");
const theme_53 = @embedFile("themes/gruvbox-dark-medium.json");
const theme_54 = @embedFile("themes/gruvbox-dark-soft.json");
const theme_55 = @embedFile("themes/gruvbox-light-hard.json");
const theme_56 = @embedFile("themes/gruvbox-light-medium.json");
const theme_57 = @embedFile("themes/gruvbox-light-soft.json");
const theme_58 = @embedFile("themes/horizon-bright.json");
const theme_59 = @embedFile("themes/horizon.json");
const theme_60 = @embedFile("themes/night-owl-light.json");
const theme_61 = @embedFile("themes/one-light.json");
const theme_62 = @embedFile("themes/rose-pine-dawn.json");
const theme_63 = @embedFile("themes/rose-pine-moon.json");
const theme_64 = @embedFile("themes/rose-pine.json");
const theme_65 = @embedFile("themes/vesper.json");
...
pub fn listThemes(allocator: Allocator, list: *std.ArrayList(ThemeInfo)) !void {
    ...
    }
    {
        ...
        var ti = ThemeInfo{ .embedded_file = bytes };
        @memcpy(ti.name[0.."ayu-light".len], "ayu-light");
        ti.id = list.items.len + 1;
        try list.append(allocator, ti);
    }
    {
        ...
        var ti = ThemeInfo{ .embedded_file = bytes };
        @memcpy(ti.name[0.."ayu-mirage".len], "ayu-mirage");
        ti.id = list.items.len + 1;
        try list.append(allocator, ti);
    }
    {
    ...
    }
    {
        ...
        var ti = ThemeInfo{ .embedded_file = bytes };
        @memcpy(ti.name[0.."horizon-bright".len], "horizon-bright");
        ti.id = list.items.len + 1;
        try list.append(allocator, ti);
    }
    {
        ...
        var ti = ThemeInfo{ .embedded_file = bytes };
        @memcpy(ti.name[0.."horizon".len], "horizon");
        ti.id = list.items.len + 1;
        try list.append(allocator, ti);
    }
    {
        ...
        var ti = ThemeInfo{ .embedded_file = bytes };
        @memcpy(ti.name[0.."night-owl-light".len], "night-owl-light");
        ti.id = list.items.len + 1;
        try list.append(allocator, ti);
    }
    {
        const bytes: []const u8 = theme_61[0..theme_61.len];
        var ti = ThemeInfo{ .embedded_file = bytes };
    ...
    {
        const bytes: []const u8 = theme_62[0..theme_62.len];
        var ti = ThemeInfo{ .embedded_file = bytes };
    ...
    {
        const bytes: []const u8 = theme_63[0..theme_63.len];
        var ti = ThemeInfo{ .embedded_file = bytes };
    ...
    {
        const bytes: []const u8 = theme_64[0..theme_64.len];
        var ti = ThemeInfo{ .embedded_file = bytes };
    ...
    {
        const bytes: []const u8 = theme_65[0..theme_65.len];
        var ti = ThemeInfo{ .embedded_file = bytes };
...
const grammar_2 = @embedFile("grammars/ada.json");
const grammar_3 = @embedFile("grammars/angular-expression.json");
const grammar_4 = @embedFile("grammars/angular-html.json");
const grammar_5 = @embedFile("grammars/angular-inline-style.json");
const grammar_6 = @embedFile("grammars/angular-inline-template.json");
const grammar_7 = @embedFile("grammars/angular-let-declaration.json");
const grammar_8 = @embedFile("grammars/angular-template-blocks.json");
const grammar_9 = @embedFile("grammars/angular-template.json");
const grammar_10 = @embedFile("grammars/angular-ts.json");
const grammar_11 = @embedFile("grammars/apache.json");
const grammar_12 = @embedFile("grammars/apl.json");
const grammar_13 = @embedFile("grammars/applescript.json");
const grammar_14 = @embedFile("grammars/ara.json");
const grammar_15 = @embedFile("grammars/asm.json");
const grammar_16 = @embedFile("grammars/astro.json");
const grammar_17 = @embedFile("grammars/awk.json");
const grammar_18 = @embedFile("grammars/ballerina.json");
const grammar_19 = @embedFile("grammars/bat.json");
const grammar_20 = @embedFile("grammars/bibtex.json");
const grammar_21 = @embedFile("grammars/bsl.json");
const grammar_22 = @embedFile("grammars/c.json");
const grammar_23 = @embedFile("grammars/cairo.json");
const grammar_24 = @embedFile("grammars/clojure.json");
const grammar_25 = @embedFile("grammars/cmake.json");
const grammar_26 = @embedFile("grammars/codeowners.json");
const grammar_27 = @embedFile("grammars/codeql.json");
const grammar_28 = @embedFile("grammars/coffee.json");
const grammar_29 = @embedFile("grammars/common-lisp.json");
const grammar_30 = @embedFile("grammars/coq.json");
const grammar_31 = @embedFile("grammars/cpp-macro.json");
const grammar_32 = @embedFile("grammars/cpp.json");
const grammar_33 = @embedFile("grammars/crystal.json");
const grammar_34 = @embedFile("grammars/csv.json");
const grammar_35 = @embedFile("grammars/cue.json");
const grammar_36 = @embedFile("grammars/cypher.json");
const grammar_37 = @embedFile("grammars/d.json");
const grammar_38 = @embedFile("grammars/dax.json");
const grammar_39 = @embedFile("grammars/desktop.json");
const grammar_40 = @embedFile("grammars/diff.json");
const grammar_41 = @embedFile("grammars/docker.json");
const grammar_42 = @embedFile("grammars/dotenv.json");
const grammar_43 = @embedFile("grammars/dream-maker.json");
const grammar_44 = @embedFile("grammars/edge.json");
const grammar_45 = @embedFile("grammars/elixir.json");
const grammar_46 = @embedFile("grammars/elm.json");
const grammar_47 = @embedFile("grammars/erb.json");
const grammar_48 = @embedFile("grammars/erlang.json");
const grammar_49 = @embedFile("grammars/es-tag-css.json");
const grammar_50 = @embedFile("grammars/es-tag-glsl.json");
const grammar_51 = @embedFile("grammars/es-tag-html.json");
const grammar_52 = @embedFile("grammars/es-tag-xml.json");
const grammar_53 = @embedFile("grammars/fennel.json");
const grammar_54 = @embedFile("grammars/fluent.json");
const grammar_55 = @embedFile("grammars/gdresource.json");
const grammar_56 = @embedFile("grammars/gdshader.json");
const grammar_57 = @embedFile("grammars/genie.json");
const grammar_58 = @embedFile("grammars/gherkin.json");
const grammar_59 = @embedFile("grammars/git-commit.json");
const grammar_60 = @embedFile("grammars/git-rebase.json");
const grammar_61 = @embedFile("grammars/gleam.json");
const grammar_62 = @embedFile("grammars/glimmer-js.json");
const grammar_63 = @embedFile("grammars/glimmer-ts.json");
const grammar_64 = @embedFile("grammars/glsl.json");
const grammar_65 = @embedFile("grammars/gnuplot.json");
const grammar_66 = @embedFile("grammars/graphql.json");
const grammar_67 = @embedFile("grammars/groovy.json");
const grammar_68 = @embedFile("grammars/haml.json");
const grammar_69 = @embedFile("grammars/handlebars.json");
const grammar_70 = @embedFile("grammars/haskell.json");
const grammar_71 = @embedFile("grammars/haxe.json");
const grammar_72 = @embedFile("grammars/hcl.json");
const grammar_73 = @embedFile("grammars/hjson.json");
const grammar_74 = @embedFile("grammars/hlsl.json");
const grammar_75 = @embedFile("grammars/html-derivative.json");
const grammar_76 = @embedFile("grammars/html.json");
const grammar_77 = @embedFile("grammars/http.json");
const grammar_78 = @embedFile("grammars/hxml.json");
const grammar_79 = @embedFile("grammars/hy.json");
const grammar_80 = @embedFile("grammars/imba.json");
const grammar_81 = @embedFile("grammars/ini.json");
const grammar_82 = @embedFile("grammars/java.json");
const grammar_83 = @embedFile("grammars/javascript.json");
const grammar_84 = @embedFile("grammars/jinja-html.json");
const grammar_85 = @embedFile("grammars/jinja.json");
const grammar_86 = @embedFile("grammars/jison.json");
const grammar_87 = @embedFile("grammars/json.json");
const grammar_88 = @embedFile("grammars/json5.json");
const grammar_89 = @embedFile("grammars/jsonc.json");
const grammar_90 = @embedFile("grammars/jsonl.json");
const grammar_91 = @embedFile("grammars/jsonnet.json");
const grammar_92 = @embedFile("grammars/jssm.json");
const grammar_93 = @embedFile("grammars/jsx.json");
const grammar_94 = @embedFile("grammars/kotlin.json");
const grammar_95 = @embedFile("grammars/less.json");
const grammar_96 = @embedFile("grammars/liquid.json");
const grammar_97 = @embedFile("grammars/log.json");
const grammar_98 = @embedFile("grammars/logo.json");
const grammar_99 = @embedFile("grammars/make.json");
const grammar_100 = @embedFile("grammars/matlab.json");
const grammar_101 = @embedFile("grammars/mdx.json");
const grammar_102 = @embedFile("grammars/mipsasm.json");
const grammar_103 = @embedFile("grammars/narrat.json");
const grammar_104 = @embedFile("grammars/nginx.json");
const grammar_105 = @embedFile("grammars/nim.json");
const grammar_106 = @embedFile("grammars/objective-c.json");
const grammar_107 = @embedFile("grammars/objective-cpp.json");
const grammar_108 = @embedFile("grammars/ocaml.json");
const grammar_109 = @embedFile("grammars/pascal.json");
const grammar_110 = @embedFile("grammars/perl.json");
const grammar_111 = @embedFile("grammars/plsql.json");
const grammar_112 = @embedFile("grammars/po.json");
const grammar_113 = @embedFile("grammars/polar.json");
const grammar_114 = @embedFile("grammars/postcss.json");
const grammar_115 = @embedFile("grammars/powerquery.json");
const grammar_116 = @embedFile("grammars/powershell.json");
const grammar_117 = @embedFile("grammars/prisma.json");
const grammar_118 = @embedFile("grammars/prolog.json");
const grammar_119 = @embedFile("grammars/pug.json");
const grammar_120 = @embedFile("grammars/puppet.json");
const grammar_121 = @embedFile("grammars/purescript.json");
const grammar_122 = @embedFile("grammars/python.json");
const grammar_123 = @embedFile("grammars/qml.json");
const grammar_124 = @embedFile("grammars/qmldir.json");
const grammar_125 = @embedFile("grammars/qss.json");
const grammar_126 = @embedFile("grammars/racket.json");
const grammar_127 = @embedFile("grammars/raku.json");
const grammar_128 = @embedFile("grammars/reg.json");
const grammar_129 = @embedFile("grammars/regexp.json");
const grammar_130 = @embedFile("grammars/rel.json");
const grammar_131 = @embedFile("grammars/riscv.json");
const grammar_132 = @embedFile("grammars/rst.json");
const grammar_133 = @embedFile("grammars/rust.json");
const grammar_134 = @embedFile("grammars/sas.json");
const grammar_135 = @embedFile("grammars/sass.json");
const grammar_136 = @embedFile("grammars/scala.json");
const grammar_137 = @embedFile("grammars/scheme.json");
const grammar_138 = @embedFile("grammars/scss.json");
const grammar_139 = @embedFile("grammars/sdbl.json");
const grammar_140 = @embedFile("grammars/shaderlab.json");
const grammar_141 = @embedFile("grammars/shellscript.json");
const grammar_142 = @embedFile("grammars/shellsession.json");
const grammar_143 = @embedFile("grammars/smalltalk.json");
const grammar_144 = @embedFile("grammars/soy.json");
const grammar_145 = @embedFile("grammars/sparql.json");
const grammar_146 = @embedFile("grammars/splunk.json");
const grammar_147 = @embedFile("grammars/ssh-config.json");
const grammar_148 = @embedFile("grammars/stata.json");
const grammar_149 = @embedFile("grammars/stylus.json");
const grammar_150 = @embedFile("grammars/system-verilog.json");
const grammar_151 = @embedFile("grammars/systemd.json");
const grammar_152 = @embedFile("grammars/talonscript.json");
const grammar_153 = @embedFile("grammars/tasl.json");
const grammar_154 = @embedFile("grammars/tcl.json");
const grammar_155 = @embedFile("grammars/templ.json");
const grammar_156 = @embedFile("grammars/terraform.json");
const grammar_157 = @embedFile("grammars/toml.json");
const grammar_158 = @embedFile("grammars/ts-tags.json");
const grammar_159 = @embedFile("grammars/tsv.json");
const grammar_160 = @embedFile("grammars/tsx.json");
const grammar_161 = @embedFile("grammars/turtle.json");
const grammar_162 = @embedFile("grammars/twig.json");
const grammar_163 = @embedFile("grammars/typescript.json");
const grammar_164 = @embedFile("grammars/typst.json");
const grammar_165 = @embedFile("grammars/vala.json");
const grammar_166 = @embedFile("grammars/vb.json");
const grammar_167 = @embedFile("grammars/verilog.json");
const grammar_168 = @embedFile("grammars/vhdl.json");
const grammar_169 = @embedFile("grammars/viml.json");
const grammar_170 = @embedFile("grammars/vue-html.json");
const grammar_171 = @embedFile("grammars/vue-sfc-style-variable-injection.json");
const grammar_172 = @embedFile("grammars/vue-vine.json");
const grammar_173 = @embedFile("grammars/vyper.json");
const grammar_174 = @embedFile("grammars/wasm.json");
const grammar_175 = @embedFile("grammars/wenyan.json");
const grammar_176 = @embedFile("grammars/wgsl.json");
const grammar_177 = @embedFile("grammars/wikitext.json");
const grammar_178 = @embedFile("grammars/wit.json");
const grammar_179 = @embedFile("grammars/wolfram.json");
const grammar_180 = @embedFile("grammars/xml.json");
const grammar_181 = @embedFile("grammars/xsl.json");
const grammar_182 = @embedFile("grammars/yaml.json");
const grammar_183 = @embedFile("grammars/zenscript.json");
const grammar_184 = @embedFile("grammars/zig.json");
const grammar_185 = @embedFile("grammars/actionscript-3.json");
const grammar_186 = @embedFile("grammars/ahk.json");
const grammar_187 = @embedFile("grammars/ahk2.json");
const grammar_188 = @embedFile("grammars/apex.json");
const grammar_189 = @embedFile("grammars/asciidoc.json");
const grammar_190 = @embedFile("grammars/beancount.json");
const grammar_191 = @embedFile("grammars/berry.json");
const grammar_192 = @embedFile("grammars/bicep.json");
const grammar_193 = @embedFile("grammars/bird2.json");
const grammar_194 = @embedFile("grammars/blade.json");
const grammar_195 = @embedFile("grammars/c3.json");
const grammar_196 = @embedFile("grammars/cadence.json");
const grammar_197 = @embedFile("grammars/chapel.json");
const grammar_198 = @embedFile("grammars/clarity.json");
const grammar_199 = @embedFile("grammars/cobol.json");
const grammar_200 = @embedFile("grammars/csharp.json");
const grammar_201 = @embedFile("grammars/css.json");
const grammar_202 = @embedFile("grammars/dart.json");
const grammar_203 = @embedFile("grammars/emacs-lisp.json");
const grammar_204 = @embedFile("grammars/es-tag-sql.json");
const grammar_205 = @embedFile("grammars/fish.json");
const grammar_206 = @embedFile("grammars/fortran-fixed-form.json");
const grammar_207 = @embedFile("grammars/fortran-free-form.json");
const grammar_208 = @embedFile("grammars/fsharp.json");
const grammar_209 = @embedFile("grammars/gdscript.json");
const grammar_210 = @embedFile("grammars/gn.json");
const grammar_211 = @embedFile("grammars/go.json");
const grammar_212 = @embedFile("grammars/hack.json");
const grammar_213 = @embedFile("grammars/hurl.json");
const grammar_214 = @embedFile("grammars/julia.json");
const grammar_215 = @embedFile("grammars/just.json");
const grammar_216 = @embedFile("grammars/kdl.json");
const grammar_217 = @embedFile("grammars/kusto.json");
const grammar_218 = @embedFile("grammars/latex.json");
const grammar_219 = @embedFile("grammars/lean.json");
const grammar_220 = @embedFile("grammars/llvm.json");
const grammar_221 = @embedFile("grammars/lua.json");
const grammar_222 = @embedFile("grammars/luau.json");
const grammar_223 = @embedFile("grammars/markdown-nix.json");
const grammar_224 = @embedFile("grammars/markdown-vue.json");
const grammar_225 = @embedFile("grammars/markdown.json");
const grammar_226 = @embedFile("grammars/marko.json");
const grammar_227 = @embedFile("grammars/mdc.json");
const grammar_228 = @embedFile("grammars/mermaid.json");
const grammar_229 = @embedFile("grammars/mojo.json");
const grammar_230 = @embedFile("grammars/moonbit.json");
const grammar_231 = @embedFile("grammars/move.json");
const grammar_232 = @embedFile("grammars/nextflow-groovy.json");
const grammar_233 = @embedFile("grammars/nextflow.json");
const grammar_234 = @embedFile("grammars/nix.json");
const grammar_235 = @embedFile("grammars/nushell.json");
const grammar_236 = @embedFile("grammars/odin.json");
const grammar_237 = @embedFile("grammars/openscad.json");
const grammar_238 = @embedFile("grammars/org.json");
const grammar_239 = @embedFile("grammars/php.json");
const grammar_240 = @embedFile("grammars/pkl.json");
const grammar_241 = @embedFile("grammars/proto.json");
const grammar_242 = @embedFile("grammars/r.json");
const grammar_243 = @embedFile("grammars/razor.json");
const grammar_244 = @embedFile("grammars/ron.json");
const grammar_245 = @embedFile("grammars/rosmsg.json");
const grammar_246 = @embedFile("grammars/ruby.json");
const grammar_247 = @embedFile("grammars/solidity.json");
const grammar_248 = @embedFile("grammars/sql.json");
const grammar_249 = @embedFile("grammars/surrealql.json");
const grammar_250 = @embedFile("grammars/svelte.json");
const grammar_251 = @embedFile("grammars/swift.json");
const grammar_252 = @embedFile("grammars/tex.json");
const grammar_253 = @embedFile("grammars/typespec.json");
const grammar_254 = @embedFile("grammars/v.json");
const grammar_255 = @embedFile("grammars/vue-directives.json");
const grammar_256 = @embedFile("grammars/vue-interpolations.json");
const grammar_257 = @embedFile("grammars/vue.json");
...
pub fn listGrammars(allocator: Allocator, list: *std.ArrayList(GrammarInfo)) !void {
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 2, .inject_to_count = 0, .inject_only = false };
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 1, .inject_only = true };
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 3, .inject_only = true };
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 8, .inject_to_count = 0, .inject_only = false };
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 3, .inject_to_count = 0, .inject_only = false };
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 1, .inject_to_count = 0, .inject_only = false };
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 5, .inject_to_count = 0, .inject_only = false };
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 6, .inject_to_count = 0, .inject_only = false };
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 8, .inject_to_count = 2, .inject_only = true };
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 4, .inject_to_count = 0, .inject_only = false };
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 1, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."ahk".len], "ahk");
        @memcpy(gi.scope_name[0.."source.ahk".len], "source.ahk");
        @memcpy(gi.file_types[0][0.."ahk".len], "ahk");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."ahk2".len], "ahk2");
        @memcpy(gi.scope_name[0.."source.ahk2".len], "source.ahk2");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 7, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."bird2".len], "bird2");
        @memcpy(gi.scope_name[0.."source.bird2".len], "source.bird2");
        @memcpy(gi.file_types[0][0.."conf".len], "conf");
        @memcpy(gi.file_types[1][0.."bird".len], "bird");
        @memcpy(gi.file_types[2][0.."bird2".len], "bird2");
        @memcpy(gi.file_types[3][0.."bird3".len], "bird3");
        @memcpy(gi.file_types[4][0.."bird.conf".len], "bird.conf");
        @memcpy(gi.file_types[5][0.."bird2.conf".len], "bird2.conf");
        @memcpy(gi.file_types[6][0.."bird3.conf".len], "bird3.conf");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 3, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."c3".len], "c3");
        @memcpy(gi.scope_name[0.."source.c3".len], "source.c3");
        @memcpy(gi.file_types[0][0.."c3".len], "c3");
        @memcpy(gi.file_types[1][0.."c3i".len], "c3i");
        @memcpy(gi.file_types[2][0.."c3t".len], "c3t");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 1, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."chapel".len], "chapel");
        @memcpy(gi.scope_name[0.."source.chapel".len], "source.chapel");
        @memcpy(gi.file_types[0][0.."chpl".len], "chpl");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
    ...
    }
    {
        ...
        @memcpy(gi.file_types[4][0.."cblsrce".len], "cblsrce");
        @memcpy(gi.file_types[5][0.."cblcpy".len], "cblcpy");
        @memcpy(gi.file_types[6][0.."lks".len], "lks");
        @memcpy(gi.file_types[7][0.."pdv".len], "pdv");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 2, .inject_only = true };
        @memcpy(gi.name[0.."es-tag-sql".len], "es-tag-sql");
        @memcpy(gi.scope_name[0.."inline.tagged-template-sql".len], "inline.tagged-template-sql");
        @memcpy(gi.inject_to[0][0.."source.ts".len], "source.ts");
        @memcpy(gi.inject_to[1][0.."source.js".len], "source.js");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."gn".len], "gn");
        @memcpy(gi.scope_name[0.."source.gn".len], "source.gn");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."hurl".len], "hurl");
        @memcpy(gi.scope_name[0.."source.hurl".len], "source.hurl");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 3, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."just".len], "just");
        @memcpy(gi.scope_name[0.."source.just".len], "source.just");
        @memcpy(gi.file_types[0][0.."just".len], "just");
        @memcpy(gi.file_types[1][0.."justfile".len], "justfile");
        @memcpy(gi.file_types[2][0.."Justfile".len], "Justfile");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."kdl".len], "kdl");
        @memcpy(gi.scope_name[0.."source.kdl".len], "source.kdl");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 1, .inject_only = true };
        @memcpy(gi.name[0.."markdown-nix".len], "markdown-nix");
        @memcpy(gi.scope_name[0.."markdown.nix.codeblock".len], "markdown.nix.codeblock");
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 1, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."moonbit".len], "moonbit");
        @memcpy(gi.scope_name[0.."source.moonbit".len], "source.moonbit");
        @memcpy(gi.file_types[0][0.."mbt".len], "mbt");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."nextflow-groovy".len], "nextflow-groovy");
        @memcpy(gi.scope_name[0.."source.nextflow-groovy".len], "source.nextflow-groovy");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
    ...
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."odin".len], "odin");
        @memcpy(gi.scope_name[0.."source.odin".len], "source.odin");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 1, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."openscad".len], "openscad");
        @memcpy(gi.scope_name[0.."source.scad".len], "source.scad");
        @memcpy(gi.file_types[0][0.."scad".len], "scad");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
        ...
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."org".len], "org");
        @memcpy(gi.scope_name[0.."source.org".len], "source.org");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
        const bytes: []const u8 = grammar_239[0..grammar_239.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 0, .inject_only = false };
    ...
    {
        const bytes: []const u8 = grammar_240[0..grammar_240.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 2, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."pkl".len], "pkl");
        @memcpy(gi.scope_name[0.."source.pkl".len], "source.pkl");
        @memcpy(gi.file_types[0][0.."pkl".len], "pkl");
        @memcpy(gi.file_types[1][0.."pcf".len], "pcf");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
        const bytes: []const u8 = grammar_241[0..grammar_241.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 1, .inject_to_count = 0, .inject_only = false };
    ...
    {
        const bytes: []const u8 = grammar_242[0..grammar_242.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 3, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."r".len], "r");
        @memcpy(gi.scope_name[0.."source.r".len], "source.r");
        @memcpy(gi.file_types[0][0.."R".len], "R");
        @memcpy(gi.file_types[1][0.."r".len], "r");
        @memcpy(gi.file_types[2][0.."Rprofile".len], "Rprofile");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
        const bytes: []const u8 = grammar_243[0..grammar_243.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 2, .inject_to_count = 0, .inject_only = false };
    ...
    {
        const bytes: []const u8 = grammar_244[0..grammar_244.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."ron".len], "ron");
        @memcpy(gi.scope_name[0.."source.ron".len], "source.ron");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
        const bytes: []const u8 = grammar_245[0..grammar_245.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 3, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."rosmsg".len], "rosmsg");
        @memcpy(gi.scope_name[0.."source.rosmsg".len], "source.rosmsg");
        @memcpy(gi.file_types[0][0.."msg".len], "msg");
        @memcpy(gi.file_types[1][0.."srv".len], "srv");
        @memcpy(gi.file_types[2][0.."action".len], "action");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
        const bytes: []const u8 = grammar_246[0..grammar_246.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 0, .inject_only = false };
    ...
    {
        const bytes: []const u8 = grammar_247[0..grammar_247.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 1, .inject_to_count = 0, .inject_only = false };
    ...
    {
        const bytes: []const u8 = grammar_248[0..grammar_248.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 0, .inject_only = false };
    ...
    {
        const bytes: []const u8 = grammar_249[0..grammar_249.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 2, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."surrealql".len], "surrealql");
        @memcpy(gi.scope_name[0.."source.surrealql".len], "source.surrealql");
        @memcpy(gi.file_types[0][0..".surql".len], ".surql");
        @memcpy(gi.file_types[1][0..".surrealql".len], ".surrealql");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
    {
        const bytes: []const u8 = grammar_250[0..grammar_250.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 1, .inject_to_count = 0, .inject_only = false };
    ...
    {
        const bytes: []const u8 = grammar_251[0..grammar_251.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 1, .inject_to_count = 0, .inject_only = false };
    ...
    {
        const bytes: []const u8 = grammar_252[0..grammar_252.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 0, .inject_only = false };
    ...
    {
        const bytes: []const u8 = grammar_253[0..grammar_253.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 1, .inject_to_count = 0, .inject_only = false };
    ...
    {
        const bytes: []const u8 = grammar_254[0..grammar_254.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 3, .inject_to_count = 0, .inject_only = false };
    ...
    {
        const bytes: []const u8 = grammar_255[0..grammar_255.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 4, .inject_only = true };
    ...
    {
        const bytes: []const u8 = grammar_256[0..grammar_256.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 4, .inject_only = true };
    ...
    {
        const bytes: []const u8 = grammar_257[0..grammar_257.len];
        var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, .inject_to_count = 0, .inject_only = false };
        @memcpy(gi.name[0.."vue".len], "vue");
        @memcpy(gi.scope_name[0.."text.html.vue".len], "text.html.vue");
        gi.id = list.items.len + 1;
        try list.append(allocator, gi);
    }
}
