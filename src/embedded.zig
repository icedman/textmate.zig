...
pub fn listGrammars(allocator: std.mem.Allocator, list: *std.ArrayList(GrammarInfo)) !void {
  _ = allocator;
  {
    ...
    var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 0, };
  ...
  }
  {
    ...
    var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 4, };
  ...
  }
  {
    ...
    var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 3, };
  ...
  }
  {
    ...
    var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 1, };
  ...
  }
  {
    ...
    var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 2, };
  ...
  }
  {
    ...
    var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 8, };
  ...
  }
  {
    ...
    var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 5, };
  ...
  }
  {
    ...
    var gi = GrammarInfo{ .embedded_file = bytes, .file_types_count = 6, };
